...
// import { HomeIcon, UserIcon, InformationCircleIcon, DocumentTextIcon, Bars3Icon } from "@heroicons/react/24/outline";
...
//   return (
//     <aside className={`bg-gray-800 text-white min-h-screen p-4 transition-all duration-300 ${sidebarWidth}`}>
...
const Sidebar: React.FC = () => {
  ...
  // Auto-collapse on small screens (keep it collapsed)
  useEffect(() => {
    if (windowWidth < 768) {
      setCollapsed(true);
    }
